...
* Autoloader is implemented to use the generated composer autoloader in `vendor/autoload.php`,
  instead of the one provided by Drupal (`html/vendor/autoload.php`).
* Modules (packages of type `drupal-module`) will be placed in `html/modules/contrib/`
* Theme (packages of type `drupal-theme`) will be placed in `html/themes/contrib/`
...
index.php, update.php, …) to the html/ directory of your project. If you have not customized those files you could choose
